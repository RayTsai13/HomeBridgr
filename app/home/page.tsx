          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-purple-50 text-purple-700 px-3 py-2 pr-8 rounded-lg text-sm font-medium border border-purple-200 hover:bg-purple-100 transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-purple-400"
              >
              ...
              <Globe className="absolute right-2 top-1/2 -translate-y-1/2 w-4 h-4 text-purple-600 pointer-events-none" />
            </div>
