...
export function ProfileView() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <div className="gradient-purple-soft dark:bg-gradient-to-br dark:from-purple-900/50 dark:to-violet-900/50 rounded-3xl p-6 mb-6 relative overflow-hidden">
        <div className="absolute top-4 right-4">
          <button className="w-10 h-10 rounded-full bg-white/80 dark:bg-gray-700/80 hover:bg-white dark:hover:bg-gray-700 flex items-center justify-center transition-colors">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          />
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">{currentUser.displayName}</h1>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">342</div>
      ...
      <div className="flex gap-3 mb-6">
        ...
        <button className="flex-1 py-3 rounded-2xl bg-white dark:bg-gray-700 border-2 border-purple-200 dark:border-purple-600 text-purple-600 dark:text-purple-400 font-semibold hover:bg-purple-50 dark:hover:bg-gray-600 transition-colors">
          Share Profile
        </button>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div
            key={i}
            className="aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-purple-200 to-violet-200 dark:from-purple-800/50 dark:to-violet-800/50"
          >
            <img
      ...
      {/* Home Circle Section */}
      <div className="mt-8 bg-white dark:bg-gray-800 rounded-3xl p-6 border border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-2 mb-4">
          <Users className="w-5 h-5 text-purple-600 dark:text-purple-400" />
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Home Circle</h2>
        </div>
        <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">Your closest connections</p>
